...
public class Data {
    ...
    public static void guardarC(Curso u){
        cursos.add(u);
    }
    ...
    public static void eliminarC(Curso p){
        for (int i = 0; i < cursos.size(); i++) {
            if(cursos.get(i).getId().equals(p.getId())){
                cursos.remove(i);
                break;
            }
        }
    ...
    public static void guardarCp(Compra u){
        compras.add(u);
    }
    ...
    public static void eliminarCp(Compra p){
        for (int i = 0; i < compras.size(); i++) {
            if(compras.get(i).getId().equals(p.getId())){
                compras.remove(i);
                break;
            }
        }
